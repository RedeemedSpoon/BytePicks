$(document).ready(function () {
   ...
   if (window.location.pathname === "/") {
      const textList = ["Your Knowledge Hub.", "Discover. Learn. Thrive.", "Beyond the Ordinary.",
         "Quality Over Quantity.", "Future-Proof Yourself.", "Masterpieces at Your Fingertips!", "Explore. Decode. Dominate.",
         "The Web's Hidden Gems!", "Elevate Your Online Experience.", "Unleash Your Potential!"];
      let isTyping = true;
      let charIndex = 0;
      let index = 0;
